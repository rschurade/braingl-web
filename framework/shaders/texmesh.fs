...
void main(void) 
{
	vec4 fragmentColor1 = texture2D(uSampler1, vec2(vTextureCoord.s, 1.0 - vTextureCoord.t));
	...
	vec3 color = blinnPhongIllumination(
            // material properties
            fragmentColor1.rgb * 0.5,                 // ambient color
            fragmentColor1.rgb * 0.5,                 // diffuse color
            fragmentColor1.rgb * 0.8,                 // specular color
            1.0,                              // shininess
